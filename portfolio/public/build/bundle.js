...
var app = (function () {
    ...
    /* src/components/NameTitle.svelte generated by Svelte v3.59.2 */

    const file$4 = "src/components/NameTitle.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			p = element("p");
    			p.textContent = "Sebastian Barry";
    			attr_dev(p, "class", "div__link--title gradient-title grow-text svelte-1hs7yyi");
    			add_location(p, file$4, 6, 2, 109);
    			attr_dev(div0, "class", "div__link svelte-1hs7yyi");
    			set_style(div0, "padding", "2vh");
    			add_location(div0, file$4, 5, 1, 62);
    			attr_dev(div1, "id", "NameTitle");
    			attr_dev(div1, "class", "rotate-box svelte-1hs7yyi");
    ...
    function instance$5($$self, $$props) {
    	...
    	validate_slots('NameTitle', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<NameTitle> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class NameTitle extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$4(ctx) {
    	...
    	let li3;
    	let current;
    	nametitle = new NameTitle({ $$inline: true });

    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(nametitle.$$.fragment);
    			t0 = space();
    			p = element("p");
    			...
    			t8 = space();
    			li3 = element("li");
    			li3.textContent = "Resume";
    			add_location(p, file$3, 6, 1, 105);
    			add_location(li0, file$3, 8, 2, 139);
    			add_location(li1, file$3, 9, 2, 155);
    			add_location(li2, file$3, 10, 2, 172);
    			add_location(li3, file$3, 11, 2, 191);
    			add_location(ul, file$3, 7, 1, 132);
    			attr_dev(div, "id", "main__section");
    			attr_dev(div, "class", "svelte-1thoryo");
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(nametitle, div, null);
    			append_dev(div, t0);
    			append_dev(div, p);
    			append_dev(div, t2);
    			append_dev(div, ul);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(nametitle.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(nametitle.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			destroy_component(nametitle);
    		}
    	};
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$2, 41, 0, 1439);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file, 7, 4, 155);
    			attr_dev(main, "class", "app svelte-1ozpxtq");
    			add_location(main, file, 6, 2, 132);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Home, Route, Router, Link });
    	return [];
    }
